...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Exidy2_MiSTer.git"
CORE_NAME=(Arcade-Exidy2)
...
UPSTREAM_CORE_NAME=(Arcade-Exidy2)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-Exidy2.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Exidy2.rbf)
